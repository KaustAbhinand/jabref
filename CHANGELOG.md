...
- The built-in HTTP server no longer serves your libraries to arbitrary websites: cross-origin access is limited to callers on your own machine (loopback applications and browser extensions), and requests that change data are rejected when they come from a website. [TODO](https://github.com/JabRef/jabref/pull/TODO)
- We hardened the fetchers and importers against [XML Entity Expansion attacks](https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html). [#16359](https://github.com/JabRef/jabref/pull/16359) [TODO](https://github.com/JabRef/jabref/pull/TODO)
